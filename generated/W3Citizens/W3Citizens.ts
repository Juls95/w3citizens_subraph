...
export class W3Citizens__idToEventResult {
  value0: Bytes;
  value1: string;
  value2: Address;
  value3: BigInt;
...
export class W3Citizens extends ethereum.SmartContract {
  static bind(address: Address): W3Citizens {
    return new W3Citizens("W3Citizens", address);
  }

  idToEvent(param0: Bytes): W3Citizens__idToEventResult {
    ...
    return new W3Citizens__idToEventResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_idToEvent(
    param0: Bytes
  ): ethereum.CallResult<W3Citizens__idToEventResult> {
    ...
    return ethereum.CallResult.fromValue(
      new W3Citizens__idToEventResult(
        value[0].toBytes(),
        value[1].toString(),
        value[2].toAddress(),
        value[3].toBigInt(),
